...
<main class="main-content">
  ...
  <nav class="breadcrumb">
          <a href="../../academics.php">Academics</a> &gt; <a href="#">Undergraduates</a> &gt; <span>ILS Elementary School
    <div class="college-heading">
      <img src="../../Assets/elemlogo.jpg" class="logo" alt="ccs logo">
      <h2 class="college-header">ILS Elementary School</h2>
    </div>

    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="../../Assets/elem1.jpg" class="d-block w-100 h-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="../../Assets/elem2.jpg" class="d-block w-100 h-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="../../Assets/elem3.jpg" class="d-block w-100 h-100" alt="...">
        </div>
      </div>
      ...
      <div class="entry-content-wrapper">
        <div class="entry-content">
          ...
          <div class="college-goals">
            <h3><strong>Elementary Goals:</strong></h3>
          ...
          <div class="programs-offered-container">
            ...
            <div class="programs-offered">
              <ul>UnderGraduate Programs
                ...
                <li><a href="#bsit">BACHELOR OF SCIENCE IN INFORMATION TECHNOLOGY</a></li>
