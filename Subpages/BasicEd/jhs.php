...
<main class="main-content">
  ...
  <nav class="breadcrumb">
          <a href="../../academics.php">Academics</a> &gt; <a href="#">Undergraduates</a> &gt; <span>ILS Junior High School
    <div class="college-heading">
      <img src="../../Assets/hslogo.png" class="logo" alt="ccs logo">
      <h2 class="college-header">ILS Junior High School</h2>
    </div>

    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="../../Assets/hs1.jpg" class="d-block w-100 h-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="../../Assets/hs2.jpg" class="d-block w-100 h-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="../../Assets/hs3.jpg" class="d-block w-100 h-100" alt="...">
        </div>
      </div>
