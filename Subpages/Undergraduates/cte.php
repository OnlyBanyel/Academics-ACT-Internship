<head>
  <style>
    ...
    <?php require_once '../../CSS/cte-style.css'; ?>  
  </style>
...
<main class="main-content">
  ...
  <nav class="breadcrumb">
          <a href="../../academics.php">Academics</a> &gt; <a href="#">Undergraduates</a> &gt; <span>College of Teacher Education</span>
        </nav>
    <div class="college-heading">
      <img src="../../Assets/ctelogo.png" class="logo" alt="ccs logo">
      <h2 class="college-header">College of Teacher Education</h2>
    </div>

    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="../../Assets/cte3.jpg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="../../Assets/cte2.jpg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="../../Assets/cte1.jpg" class="d-block w-100" alt="...">
        </div>
      </div>
      ...
      <div class="entry-content-wrapper">
        <div class="entry-content">
          ...
          <div class="college-goals">
            ...
            <ol>
              <li>Provide an enhanced curriculum and extracurricular activities that promote academic excellence, global awareness, cross-cultural understanding, inclusivity and sensitivity, and a commitment to promoting peace and addressing global challenges;</li>
              <li>Produce highly motivated and competent global and future ready teachers who are well-versed in both subject matter and pedagogy and can apply their knowledge and skills to address community needs, promoting sustainable development, peace, and harmony in the region;</li>
              <li>Establish a culture of interdisciplinary collaboration where students and faculty from various disciplines work together on cutting-edge research projects, initiatives, and courses that embrace technology and innovation to promote holistic learning experiences;</li>
              <li>Ensure that Teacher Educators stay up-to-date with the latest teaching methodologies, research trends, and technological advancements, aligning with the university’s commitment to excellence in education and research; and</li>
              <li>Maintain a rigorous quality assurance mechanisms and assessment tools to continuously monitor and improve the quality of education and research at the college.</li>
            </ol>
          </div>
          ...
          <div class="programs-offered-container">
            ...
            <div class="programs-offered">
              <ul>UnderGraduate Programs
                <li><a href="#bcaed">Bachelor of Culture and Arts Education</a></li>
                <li><a href="#beced">Bachelor of Early Childhood Education</a></li>
                <li><a href="#beed">Bachelor of Elementary Education</a></li>
                <li><a href="#bsed">Bachelor of Secondary Education</a></li>
                <li><a href="#bsned">Bachelor of Special Needs Education</a></li>
              </ul>
            </div>
          </div>
          ...
          <div class="undergrad-programs">
              ...
              <div class="bcaed">
                <p><span class="mild-emphasis" id="bscs">Bachelor of Culture and Arts Education (BCAED)</spa></p>
              ...
              <div class="beced">
                ...
                <p><span class="mild-emphasis" id="bsit">Bachelor of Early Childhood Education (BECED)</span></p>
                <p><span>Program Objectives/Outcomes:</span></p>
                <ul>
              ...
              <div class="beed">
                <p><span class="mild-emphasis" id="">Bachelor of Elementary Education (BEED)</span></p>
                <ul>
            ...
            `<div class="bsed">
            <p><span class="mild-emphasis" id="">Bachelor of Secondary Education (BSED)</span></p>
            <ul>
                <li><em>Major in Application Development</em></li>
                <li><em>Major in Networking</em></li>
            </ul>
            ...
            <div class="bsned">
            <p><span class="mild-emphasis" id="">Bachelor of Special Needs Education (BSNED)</span></p>
            <ul>
                <li><em>Major in Application Development</em></li>
                <li><em>Major in Networking</em></li>
            </ul>
